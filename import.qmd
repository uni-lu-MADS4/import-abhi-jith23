...
```{r}
# Your answer in code
blood_fat <- read_delim("D:/MyFiles/R/Programming with R and Python/import-abhi-jith23/data/blood_fat.csv", delim = ",")
```
...
```{r}
# Your answer in code
blood_fat <- read_delim("D:/MyFiles/R/Programming with R and Python/import-abhi-jith23/data/blood_fat.csv", delim=",", show_col_types=FALSE)
print(blood_fat)
```
...
readr::read_delim("D:/MyFiles/R/Programming with R and Python/import-abhi-jith23/data/blood_fat.csv", delim = ",",
                  col_types=cols(
                    age="i",
                    id="i"
                  ))
