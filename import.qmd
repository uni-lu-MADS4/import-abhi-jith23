...
```{r}
# Your answer in code
blood_fat <- read_delim("D:/MyFiles/R/Programming with R and Python/import-abhi-jith23/data/blood_fat_.csv", delim = ",")
```
...
```{r}
# Your answer in code
blood_fat <- read_delim("D:/MyFiles/R/Programming with R and Python/import-abhi-jith23/data/blood_fat_.csv", delim=",", show_col_types=FALSE)
print(blood_fat)
```
...
> id-double, group-char, weight-double, age-double, fat-double
...
```{r}
# Your answer in code
# Specify that 'age' and 'id' should be integers
readr::read_delim("D:/MyFiles/R/Programming with R and Python/import-abhi-jith23/data/blood_fat_.csv", delim = ",",
                  col_types=cols(
                    age="i",
                    id="i"
                  ))
